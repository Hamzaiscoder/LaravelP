...
<div class="container">
    ...
    <div class="container">
    <form method="POST" action="insertVaccine" enctype="multipart/form-data">
    @csrf
    <div class="col-md-6 form-group mb-3">
    <label for="txtname">Vaccine Name</label>
    <input type="text" class="form-control" id="txtname" name="txtname"  id="txtname" placeholder="Enter Vaccine Name" required>
  </div>
  <div class="col-md-6">
            <label for="status" class="form-label">Staus</label>
            <select name="status" id="status" class="form-control" required>
                <option value="">Select a Vaccine Name</option>
