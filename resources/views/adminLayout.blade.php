        ...
        <div class="tab-content" id="setting-content">
          <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
            ...
            <div class="events pt-4 px-3">
              ...
              <p class="mb-0 font-weight-thin text-gray">Creating component page build a admin/js</p>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="ViewDoctorAsadmin">Add Doctor</a></li>
                <li class="nav-item"> <a class="nav-link" href="viewVaccineDetailsAsAdmin">Add Vaccine</a></li>
                <li class="nav-item"> <a class="nav-link" href="HospitalView">Add Hospital</a></li>
                <li class="nav-item"> <a class="nav-link" href="ViewSpecAsadmin">Add Specialization</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="allchilddetailsreport">All child details</a></li>
                <li class="nav-item"><a class="nav-link" href="viewappointment">Appointment Details</a></li>
                <li class="nav-item"><a class="nav-link" href="viewaContact">Contact Details</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item">
